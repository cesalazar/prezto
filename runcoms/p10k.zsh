# Generated by Powerlevel10k configuration wizard on 2021-07-25 at 13:13 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,}_FOREGROUND=4
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VICMD,VIOWR}_FOREGROUND=1
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIVIS,}_FOREGROUND=226
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='vvv'
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_UNTRACKED  )) && res+="${untracked}${indigo}${POWERLEVEL9K_VCS_UNTRACKED_ICON}${VCS_STATUS_NUM_UNTRACKED}"
  ...
  typeset -g POWERLEVEL9K_NORDVPN_{DISCONNECTED,CONNECTING,DISCONNECTING}_VISUAL_IDENTIFIER_EXPANSION='%1F'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%172F%n %7F@ %172F%m'
  # Default context format (no privileges, no SSH): user@hostname.
  # Included the colors here to be able to interpose with the "@"
  # typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n@%m'
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%172F%n %7F@ %172F%m'
